...
(function () {
  ...
  // Set the JavaScript library that will be used for DOM manipulation and Ajax calls (a.k.a. the `$` variable). By default Backbone will use: jQuery, Zepto, or Ender; but the `setDomLibrary()` method lets you inject an alternative JavaScript library (or a mock library for testing your views outside of a browser).
  ...
  // A module that can be mixed into *any object* in order to provide it with custom events. You may bind with `on` or remove with `off` callback functions to an event; trigger`-ing an event fires all callbacks in succession.
  //
  //     var object = {};
  ...
  // Cached regular expressions for matching named param parts and split parts of route strings.
  var namedParam    = /:\w+/g;
  var splatParam    = /\*\w+/g;
